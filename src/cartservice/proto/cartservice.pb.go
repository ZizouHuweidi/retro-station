...
var file_proto_cartservice_proto_goTypes = []interface{}{
	(*CartItem)(nil),         // 0: retrostation.CartItem
	(*AddItemRequest)(nil),   // 1: retrostation.AddItemRequest
	(*EmptyCartRequest)(nil), // 2: retrostation.EmptyCartRequest
	(*GetCartRequest)(nil),   // 3: retrostation.GetCartRequest
	(*Cart)(nil),             // 4: retrostation.Cart
	(*Empty)(nil),            // 5: retrostation.Empty
}
var file_proto_cartservice_proto_depIdxs = []int32{
	0, // 0: retrostation.AddItemRequest.item:type_name -> retrostation.CartItem
	0, // 1: retrostation.Cart.items:type_name -> retrostation.CartItem
	1, // 2: retrostation.CartService.AddItem:input_type -> retrostation.AddItemRequest
	3, // 3: retrostation.CartService.GetCart:input_type -> retrostation.GetCartRequest
	2, // 4: retrostation.CartService.EmptyCart:input_type -> retrostation.EmptyCartRequest
	5, // 5: retrostation.CartService.AddItem:output_type -> retrostation.Empty
	4, // 6: retrostation.CartService.GetCart:output_type -> retrostation.Cart
	5, // 7: retrostation.CartService.EmptyCart:output_type -> retrostation.Empty
