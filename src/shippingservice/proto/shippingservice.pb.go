...
var file_proto_shippingservice_proto_goTypes = []interface{}{
	...
	(*Money)(nil),             // 1: retrostation.Money
	(*GetQuoteRequest)(nil),   // 2: retrostation.GetQuoteRequest
	(*GetQuoteResponse)(nil),  // 3: retrostation.GetQuoteResponse
	(*ShipOrderRequest)(nil),  // 4: retrostation.ShipOrderRequest
	(*ShipOrderResponse)(nil), // 5: retrostation.ShipOrderResponse
	(*Address)(nil),           // 6: retrostation.Address
}
var file_proto_shippingservice_proto_depIdxs = []int32{
	6, // 0: retrostation.GetQuoteRequest.address:type_name -> retrostation.Address
	0, // 1: retrostation.GetQuoteRequest.items:type_name -> retrostation.CartItem
	1, // 2: retrostation.GetQuoteResponse.cost_usd:type_name -> retrostation.Money
	6, // 3: retrostation.ShipOrderRequest.address:type_name -> retrostation.Address
	0, // 4: retrostation.ShipOrderRequest.items:type_name -> retrostation.CartItem
	2, // 5: retrostation.ShippingService.GetQuote:input_type -> retrostation.GetQuoteRequest
	4, // 6: retrostation.ShippingService.ShipOrder:input_type -> retrostation.ShipOrderRequest
	3, // 7: retrostation.ShippingService.GetQuote:output_type -> retrostation.GetQuoteResponse
	5, // 8: retrostation.ShippingService.ShipOrder:output_type -> retrostation.ShipOrderResponse
