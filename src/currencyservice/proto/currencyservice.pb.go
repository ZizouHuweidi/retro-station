...
var file_proto_currencyservice_proto_goTypes = []interface{}{
	(*Empty)(nil),                          // 0: retrostation.Empty
	(*Money)(nil),                          // 1: retrostation.Money
	(*GetSupportedCurrenciesResponse)(nil), // 2: retrostation.GetSupportedCurrenciesResponse
	(*CurrencyConversionRequest)(nil),      // 3: retrostation.CurrencyConversionRequest
}
var file_proto_currencyservice_proto_depIdxs = []int32{
	1, // 0: retrostation.CurrencyConversionRequest.from:type_name -> retrostation.Money
	0, // 1: retrostation.CurrencyService.GetSupportedCurrencies:input_type -> retrostation.Empty
	3, // 2: retrostation.CurrencyService.Convert:input_type -> retrostation.CurrencyConversionRequest
	2, // 3: retrostation.CurrencyService.GetSupportedCurrencies:output_type -> retrostation.GetSupportedCurrenciesResponse
	1, // 4: retrostation.CurrencyService.Convert:output_type -> retrostation.Money
