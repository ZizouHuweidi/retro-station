...
import (
	...
	"github.com/zizouhuweidi/retro-station/internal/services/catalogreadservice/internal/games"
...
func provideCatalogsMetrics(
	...
	createGameGrpcRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_create_game_grpc_requests_total", appOptions.ServiceName),
	...
	updateGameGrpcRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_update_game_grpc_requests_total", appOptions.ServiceName),
	...
	deleteGameGrpcRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_delete_game_grpc_requests_total", appOptions.ServiceName),
	...
	getGameByIdGrpcRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_get_game_by_id_grpc_requests_total", appOptions.ServiceName),
	...
	searchGameGrpcRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_search_game_grpc_requests_total", appOptions.ServiceName),
	...
	createGameRabbitMQMessages, err := meter.Float64Counter(
		fmt.Sprintf("%s_create_game_rabbitmq_messages_total", appOptions.ServiceName),
	...
	updateGameRabbitMQMessages, err := meter.Float64Counter(
		fmt.Sprintf("%s_update_game_rabbitmq_messages_total", appOptions.ServiceName),
	...
	deleteGameRabbitMQMessages, err := meter.Float64Counter(
		fmt.Sprintf("%s_delete_game_rabbitmq_messages_total", appOptions.ServiceName),
	...
	successRabbitMQMessages, err := meter.Float64Counter(
		fmt.Sprintf("%s_search_game_rabbitmq_messages_total", appOptions.ServiceName),
	...
	createGameHttpRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_create_game_http_requests_total", appOptions.ServiceName),
	...
	updateGameHttpRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_update_game_http_requests_total", appOptions.ServiceName),
	...
	deleteGameHttpRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_delete_game_http_requests_total", appOptions.ServiceName),
	...
	getGameByIdHttpRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_get_game_by_id_http_requests_total", appOptions.ServiceName),
	...
	getGamesHttpRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_get_games_http_requests_total", appOptions.ServiceName),
	...
	searchGameHttpRequests, err := meter.Float64Counter(
		fmt.Sprintf("%s_search_game_http_requests_total", appOptions.ServiceName),
