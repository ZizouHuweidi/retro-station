...
func NewGetGameByIdEndpoint(
	...
	return &getGameByIdEndpoint{GameRouteParams: params}
}
...
func (ep *getGameByIdEndpoint) handler() echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		query, err := getGameByIdQuery.NewGetGameById(request.GameId)
		if err != nil {
		...
		queryResult, err := mediatr.Send[*getGameByIdQuery.GetGameById, *dtos.GetGameByIdResponseDto](
			ctx,
			query,
		)
		if err != nil {
