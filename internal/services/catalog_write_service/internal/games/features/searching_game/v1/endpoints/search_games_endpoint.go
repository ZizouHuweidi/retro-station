...
import (
	...
	"github.com/zizouhuweidi/retro-station/internal/services/catalogwriteservice/internal/games/features/searching_game/v1/queries"
)
...
func NewSearchGamesEndpoint(
	...
	return &searchGamesEndpoint{GameRouteParams: params}
}
...
func (ep *searchGamesEndpoint) handler() echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		query, err := queries.NewSearchGames(request.SearchText, request.ListQuery)
		if err != nil {
